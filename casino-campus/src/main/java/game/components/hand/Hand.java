...
public class Hand implements Comparable<Hand> {
    ...
    private boolean isStraight() {
        ...
        return cards.get(0).getRank().getValue() == cards.get(1).getRank().getValue() - 1 &&
                cards.get(0).getRank().getValue() == cards.get(2).getRank().getValue() - 2 &&
                cards.get(0).getRank().getValue() == cards.get(3).getRank().getValue() - 3 &&
                (cards.get(0).getRank().getValue() == cards.get(4).getRank().getValue() - 4 ||
                        cards.get(0).getRank().getValue() == cards.get(4).getRank().getValue() - 12);
